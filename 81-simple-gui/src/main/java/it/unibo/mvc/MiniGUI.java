...
public class MiniGUI {
    ...
    public MiniGUI() {
        ...
        final JPanel centrPanel = new JPanel();
        centrPanel.setLayout(new BoxLayout(centrPanel, BoxLayout.X_AXIS));
        final JButton write = new JButton("Print a random number on standard output");
        canvas.add(centrPanel, BorderLayout.CENTER);
        final JLabel label = new JLabel();
        label.setText("Prova");
        canvas.add(label, BorderLayout.NORTH);
        centrPanel.add(write);
        ...
        write.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                final int numberToDisplay = randomGenerator.nextInt();
                label.setText(Integer.toString(numberToDisplay));
